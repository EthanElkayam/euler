Welcome to Euler's Game Repository!
The perfect game to memorize the important constant 'e' (Euler's number).

--*THE GAME IS JUST A FUN 1-DAY PROJECT AND SHOULD NOT REPRESENT A REAL PROJECT*--
...
For the database im using the NoSQL database 'firestore'
